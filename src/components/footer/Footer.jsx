        ...
        <div className="footerall">
          <div className="footer-left">
            <ul>
              ...
              <li>
                <a href="tel:*2555" className="d-flex">
                  <img src="./assets/img/footer1.svg" alt="" />
                  <span className="Footer_bold__3DS8B">*2555</span>
                </a>
              </li>
              <li>
                <a href="mailto:info@w-t.az">
                  <img src="./assets/img/footer2.svg" alt="" />
                  <span>info@w-t.az</span>
                </a>
              </li>
              <li>
                <div>
